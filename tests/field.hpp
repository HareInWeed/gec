...
class Field160
    : public gec::bigint::Array<LIMB_T, LN_160>,
      ...
      public gec::bigint::Exponentiation<Field160, LIMB_T, LN_160>,
    ...
    friend CRTP<Field160, gec::bigint::Constants<Field160, LIMB_T, LN_160>>;
};

class Field160_2
    : public gec::bigint::Array<LIMB2_T, LN2_160>,
      ...
      public gec::bigint::MontgomeryCarryFree<Field160_2, LIMB2_T, LN2_160,
                                              ...
                                              OneR2_160>,
      public gec::bigint::Exponentiation<Field160_2, LIMB2_T, LN2_160>,
