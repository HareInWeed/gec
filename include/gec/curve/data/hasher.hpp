...
struct PointHasher {
    ...
    __host__ __device__ GEC_INLINE PointHasher() {}
    __host__ __device__ GEC_INLINE PointHasher(const PointHasher &) {}
    ...
    operator()(const argument_type &point) const {
        ...
        size_t seed = 0;
        Hasher hasher;
        utils::SeqHasher<typename POINT::CompT, POINT::CompN, Hasher>::call(
